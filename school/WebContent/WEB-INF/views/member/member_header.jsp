...
<header style="width: 100%; margin: 0 auto">
		...
		<ul class="nav nav-pills">
			<li role="presentation" class="dropdown" style="margin-left: 100px">
				...
				role="button" aria-haspopup="true" aria-expanded="false"> 자바스크립트
			...
			<li role="presentation" class="dropdown" style="margin-left: 100px">
				<a class="dropdown-toggle" data-toggle="dropdown" href="#"
				role="button" aria-haspopup="true" aria-expanded="false"> 제이쿼리 <span
					class="caret"></span>
			</a>
				<ul class="dropdown-menu">
					<li><a href="${context}/jquery/attr.do">제이쿼리 소개</a></li>
